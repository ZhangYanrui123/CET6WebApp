...
<template>
  <div class="all">
    <el-table :data="pagination.records" border>
      <el-table-column fixed="left" prop="uuid" label="用户Id" width="180"></el-table-column>
      <el-table-column prop="suniversity" label="大学名称" width="200"></el-table-column>
      ...
      <el-table-column prop="sgrade" label="年级" width="120"></el-table-column>
        <template slot-scope="scope">
          <el-button @click="checkGrade(scope.row.uuid)" type="primary" size="small">编辑</el-button>
          <el-button @click="deleteById(scope.row.uuid)" type="danger" size="small">删除</el-button>
        </template>
    </el-table>
    <el-pagination
