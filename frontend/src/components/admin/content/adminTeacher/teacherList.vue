...
<template>
    <div class="all">
        <el-table :data="pagination.records" border>
            ...
            <el-table-column fixed="left"prop="tuniversity" label="学校" width="120"></el-table-column>
            <el-table-column prop="tcollege" label="学院" width="150"></el-table-column>
            <el-table-column prop="tno" label="工号" width="150"></el-table-column>
            ...
            <el-table-column prop="utel" label="联系方式" width="120"></el-table-column>
            <el-table-column prop="ttitle" label="职称" width="120"></el-table-column>
            <el-table-column prop="udocno" label="身份证号" width="150"></el-table-column>
